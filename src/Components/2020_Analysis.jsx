...
const SecondAnalysis = () => {
    const [Name , setName] = useState("KLRahul");
    const [Runs , setRuns] = useState("670");
    const [Four,setFour] = useState("58");
    const [Six , setSix] = useState("23");
    const [Hundred ,setHundred] = useState("1");
    const [Fifty , setFifty] = useState("5");
    const [Average , setAverage] = useState("55.83");
    const [Innings , setInng] = useState("14");
    const [Matches , setMatches] = useState("14");
         ...
         <Grid item xs={12}>
           <Grid container>
            ...
            <div className="right__division">
              <h1>{Name}</h1><br/><br/>
              <p>2020 Year data</p>
              <p>Winner team - <strong>Mumbai Indians</strong></p>
              <p>Total run in 2020 is {Runs}</p>
              <p>Average Runs-<strong> {Average}</strong></p>
              <p>Total <strong>{Hundred}</strong> century <strong>{Name} </strong>scored in 2020.</p>
              <div>
