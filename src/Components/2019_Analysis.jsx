...
function Third_analysis(){
    const [Name , setName] = useState("DavidWarner");
    const [Runs , setRuns] = useState("692");
    const [Four,setFour] = useState("57");
    const [Six , setSix] = useState("21");
    const [Hundred ,setHundred] = useState("1");
    const [Fifty , setFifty] = useState("8");
    const [Average , setAverage] = useState("69.2");
    const [Innings , setInng] = useState("12");
        ...
        <Grid item xs={12}>
          <Grid container>
           ...
           <div className="right__division">
             ...
             <p>Total run in 2019 is {Runs}</p>
             <p>Average Runs-<strong> {Average}</strong></p>
             <p>Total <strong>{Hundred}</strong> century <strong>{Name} </strong>scored in 2019.</p>
             <div>
